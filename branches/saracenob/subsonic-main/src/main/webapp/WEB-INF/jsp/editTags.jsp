...
<html>
    ...
    <body class="mainframe bgcolor1">
        ...
        <script type="text/javascript" language="javascript">
            ...
            function updateTags() {
                document.getElementById("saveTags").disabled = true;
                index = 0;
                ...
                updateNextTag();
                $("backlink").innerHTML = "<fmt:message key='common.back'/>"
            }
            ...
            function setTagsCallback(result) {
                ...
                if (index < fileCount) {
                    ...
                    document.getElementById("saveTags").disabled = false;
                }
            }
        </script>
        ...
        <div id="mainframecontainer">
            ...
            <div id="mainframemenucontainer" class="bgcolor1">
                ...
                <span id="mainframemenuright">
                    <span class="mainframemenuitem forward right"><input type="button" id="saveTags" value="<fmt:message key='common.save'/>" onclick="javascript:updateTags()" /></span>
                </span>
            </div>
