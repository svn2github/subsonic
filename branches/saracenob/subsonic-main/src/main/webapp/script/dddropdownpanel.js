...
revealcontent:function(){
    ...
    if (dir=="down" && curH<maxH || dir=="up" && curH>minH){
        ...
        if (setting.pointerimage.enabled){
            setting.arrow.src=setting.pointerimage.src[(setting.dir=="down")? 1 : 0]
            setting.arrow.style.visibility="visible"
            setting.arrow.className=(setting.dir=="up") ? "pointerimagedown" : "pointerimageup";
        }
        return
    }
    var thispanel=this
...
initpanel:function(){
    ...
    if (setting.pointerimage.enabled){
        ...
        setting.arrow=ddpanel.addpointer(tdiv.getElementsByTagName("span")[0], (setting.dir=="up") ? "pointerimagedown" : "pointerimageup", setting.pointerimage.src[setting.dir=="down"? 1:0])
    }
...
var defaultpanel=new ddpanel({
    ...
    pointerimage: {enabled: true, src: ["../style/dddropdownpanel/images/arrow-down.gif", "../style/dddropdownpanel/images/arrow-up.gif"]},
